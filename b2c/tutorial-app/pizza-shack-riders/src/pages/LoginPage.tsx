...
const GUARDIO_FAMILY_IMAGE = `/images/rider.webp`;
...
export const LoginPage: FunctionComponent = (): ReactElement => {
    ...
    return (
        <Box sx={{ 
            ...
            backgroundImage: 'url(/images/bg-img.jpg)', // Add background image
            ...
            <Box sx={{ 
                ...
                <Box sx={{ 
                    ...
                    <img src={GUARDIO_FAMILY_IMAGE} style={{ maxWidth: '100%', height: '600px' }} alt="Guardio Family" />
                </Box>
                <Box sx={{ 
                    flex: 1,
                    display: 'flex',
                    ...
                    <Typography variant="body1" paragraph sx={{ mb: 4, fontSize: '1.1rem' }}>
                        Log in to access your account and verify your license.
                    </Typography>
                    <Button
                        onClick={handleLogin}
                        fullWidth
